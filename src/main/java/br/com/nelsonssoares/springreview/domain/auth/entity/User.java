...
public class User implements UserDetails, Serializable {
    ...
    //EAGER quando o usuário é carregado, as permissões também são carregadas
    //Lazy quando o usuário é carregado, as permissões não são carregadas
    // JoinTable é uma tabela de junção, que faz a relação entre duas tabelas
